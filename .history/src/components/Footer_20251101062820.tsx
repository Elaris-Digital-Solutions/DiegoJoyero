  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        {/* Footer bottom */}
        <div className="border-t pt-8 mt-12 flex flex-col md:flex-row items-center justify-between gap-6 text-sm" style={{ borderColor: 'var(--border)', color: 'var(--textSecondary)' }}>
